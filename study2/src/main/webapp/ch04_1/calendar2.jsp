...
<body onload="itemAdd();">
<div class="calendar">
	<form id="calendarForm" action="calendar2.jsp" method="post">
		<div class="title">
			<a href="calendar2.jsp?year=<%=year%>&month=<%=month-1%>">&lt;</a>
			<select id="yearsItem" name="year" onchange="sendIt();"></select>
			<select id="monthItem" name="month" onchange="sendIt();"></select>
			<a href="calendar2.jsp?year=<%=year%>&month=<%=month+1%>">&gt;</a>
		</div>
	</form>
...
function itemAdd() {
	const years = document.getElementById('yearsItem');
	const months = document.getElementById('monthItem');
